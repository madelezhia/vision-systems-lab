...
## 💻 Technical Skills Portfolio (Modern Implementations)

**Context:** Following a strategic sabbatical in 2024 focused on AI upskilling, I developed 
these projects to demonstrate proficiency in cutting-edge computer vision and AI techniques.
...
- IBM Deep Learning with PyTorch, Keras, TensorFlow Professional Certificate
- OpenHPI Practical Computer Vision with PyTorch
- DeepLearning.AI Deep Learning Specialization

**Focus Areas:** Transformers, LangChain, Vision-Language Models, Modern MLOps
